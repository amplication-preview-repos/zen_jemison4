...
export class PaymentResolverBase {
  ...
  @graphql.ResolveField(() => Debt, {
    nullable: true,
    name: "debt",
  })
  async getDebt(@graphql.Parent() parent: Payment): Promise<Debt | null> {
    const result = await this.service.getDebt(parent.id);
